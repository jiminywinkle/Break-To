...
if global.carbon = 0  or global.metal = 0 or global.fuel = 0 or lives = 0{
	audio_stop_all()
...
if instance_number(Carbon) = 0 and instance_number(Normal) = 0 and instance_number(Fuel) = 0 and instance_number(Metal) = 0{
	audio_stop_all()
	global.stop = 1
	with (all) {
      speed = 0;
