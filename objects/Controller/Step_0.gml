...
else if global.time <= 0 and spaceship = 1{
	spaceship = 0
	audio_stop_all()
...
if instance_number(Carbon) = 0 and instance_number(Fuel) = 0 and instance_number(Metal) = 0{
	...
	else if global.roomnumber >= 5{room_goto(WinRoom)}
}